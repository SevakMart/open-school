...
import app.openschool.course.discussion.dto.basedto.IQuestion;import app.openschool.course.discussion.mapper.QuestionMapper;
...
public class PeersQuestionServiceImpl implements QuestionService {
  ...
  /////////////////////////////////////////////////////////////////////////////////
  @Override public Page<IQuestion> findQuestionByCourseId(Long enrolledCourseId, Pageable pageable) {
    return null;
    }
//////////////////////////////////////////////////////////////////////////////////
