...
public class DiscussionForumController {
  ...
  public ResponseEntity<AnswerResponseDto> createAnswer(
    ...
    public ResponseEntity<AnswerResponseDto> updatePeersAnswer(
            ...
            Long questionId,
            @Parameter(description = "Peers-Answer was updated")
            @PathVariable(value = "answerId")
            Long answerId,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Request object for updating the Peers-Question")
            @Valid
        ...
        return ResponseEntity.ok()
                .body(
                        AnswerMapper.toAnswerDto(
                                answerService.update(request,answerId,questionId, enrolledCourseId , principal.getName())));
    }

    @Operation(summary = "delete Peers Answer",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<HttpStatus> deletePeersAnswer(
            ...
            @PathVariable(value = "questionId")
            Long questionId,
            @Parameter(description = "Peers-Answer ID to be deleted")
            @PathVariable(value = "answerId")
            Long answerId, Principal principal) {
  ...
  public ResponseEntity<MentorQuestionResponseDto> createMentorQuestion(
      ...
      return ResponseEntity
              ...
              .body(MentorQuestionMapper
                      .toResponseDto(mentorQuestionService
                              .create(enrolledCourseId, requestDto, principal.getName())));
  }

    @Operation(summary = "Update Mentor Question",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<MentorQuestionResponseDto> updateMentorQuestion(
        ...
        return ResponseEntity.ok()
                .body(MentorQuestionMapper
                        .toResponseDto(
                                mentorQuestionService
                                        .update(request, questionId, enrolledCourseId, principal.getName())));
    }

    @Operation(summary = "Delete Mentor Question",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
                    @ApiResponse(responseCode = "204",
  ...
  @Operation(summary = "get all MentorQuestions related to the provided course",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
        @ApiResponse(
  ...
  public ResponseEntity<MentorQuestionResponseDto> getMentorQuestionById(
    ...
    @ApiResponses(value = {
                    @ApiResponse(responseCode = "201", description = "Creates new Mentor Answer and returns that"),
                    @ApiResponse(responseCode = "400",
                            description = "Invalid request arguments supplied or not provided",
                            content = @Content(schema = @Schema(implementation = ResponseMessage.class))),
    ...
    public ResponseEntity<AnswerResponseDto> updateMentorAnswer(
        ...
        return ResponseEntity.ok()
                .body(
                        AnswerMapper.toAnswerDto(
                                mentorAnswerService.update(request,answerId,questionId, enrolledCourseId ,principal.getName())));
    }

    @Operation(summary = "delete Mentor Answer",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204",
    ...
    public ResponseEntity<HttpStatus> deleteMentorAnswer(
            ...
            @PathVariable(value = "questionId")
            Long questionId,
            @Parameter(description = "Mentor-Answer ID to be deleted")
            @PathVariable(value = "answerId")
            Long answerId, Principal principal) {
    ...
    @Operation(summary = "get all Mentor Answers related to the provided Question",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    description =
    ...
    public ResponseEntity<Page<AnswerResponseDto>> findMentorAnswersByQuestionId(
            @Parameter(description = "Question id") @PathVariable Long questionId, Pageable pageable) {
        return ResponseEntity.ok()
                .body(AnswerMapper.toAnswerDtoPage(
                        mentorAnswerService.findAnswerByQuestionId(questionId, pageable)));
    }

    @Operation(summary = "get Mentor Answer by ID", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<AnswerResponseDto> findMentorAnswerById(
        ...
        return ResponseEntity.ok(AnswerMapper.toAnswerDto(mentorAnswerService.findAnswerById(answerId)));
    }
}
