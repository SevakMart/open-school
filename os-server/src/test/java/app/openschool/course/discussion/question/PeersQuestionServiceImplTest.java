...
class PeersQuestionServiceImplTest {
  ...
  void findQuestionByCourseId_withCorrectData() {
    ...
    when(peersQuestionRepository.findQuestionByEnrolledCourseId(enrolledCourseId, pageable, q))
  ...
  void findQuestionByCourseId_withIncorrectData() {
    ...
    when(peersQuestionRepository.findQuestionByEnrolledCourseId(wrongEnrolledCourseId, pageable, q))
