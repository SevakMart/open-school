...
public class QuizMapperTest {
  ...
  void createQuizDtoToQuiz() {
    Quiz quiz =
        QuizMapper.createQuizDtoToQuiz(QuizDtoGenerator.generateCreateQuizDto(), new Module());

    assertThat(quiz)
        .hasOnlyFields(
            "id", "description", "title", "maxGrade", "passingScore", "questions", "module");
  }
  ...
  void quizToQuizDto() {
    ...
    assertThat(quizDto)
        .hasOnlyFields(
            "id", "description", "title", "moduleId", "maxGrade", "passingScore", "questions");
  }
  ...
  @Test
  void toQuizDtoPage() {
    Page<QuizDto> quizDtoPage = QuizMapper.toQuizDtoPage(QuizGenerator.generateQuizPage());
    assertThat(quizDtoPage).hasOnlyElementsOfTypes(QuizDto.class);
  }
}
